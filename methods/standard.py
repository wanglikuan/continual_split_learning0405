...
from .utils import models_copy, all_acc, myloss

def process(model, cut_idx, args, train_loader, test_loader, labels, class_incremental, result_file='./standard.txt'):
    ...
    for task in range(args.num_task):
        ...
        for epoch in range(args.epochs):
            ...
            all_acc(task, models, test_loader, cut_idx, cur_label, class_incremental, labels, gpu, epoch, loss, result_file)
